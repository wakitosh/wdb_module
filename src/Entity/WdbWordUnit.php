 ...
 * properties, its location on annotation pages, and its sequence in the document.
 *
 * @ContentEntityType(
 *   id = "wdb_word_unit",
...
class WdbWordUnit extends ContentEntityBase implements ContentEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    // The actual text of the word as it appears in the source. Used as the entity label.
    ...
    // This loop creates a field for each category, linking to a corresponding taxonomy vocabulary.
    $grammar_categories = [
      'person' => t('Person'),
      'gender' => t('Gender'),
      'number' => t('Number'),
